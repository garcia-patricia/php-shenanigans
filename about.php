...
<div class="facts-container">
        ...
        <div class="about-fact-box">
                <span class="heart-float">
                       <img src="img/hearty.svg" alt="A little thing I love! - THING HERE PLS EDIT." class="heart-fact">
                </span>                <p class="about-fact-text">I own a weaponized fruit. Mango. She's a lovebird. </p>
        </div>
        <div class="about-fact-box">
                <span class="heart-float">
                       <img src="img/hearty.svg" alt="A little thing I love! - THING HERE PLS EDIT." class="heart-fact">
                </span>               <p class="about-fact-text">My favourite colours are teal pink and grey! </p>
        </div>
        <div class="about-fact-box">
                <span class="heart-float">
                       <img src="img/hearty.svg" alt="A little thing I love! - THING HERE PLS EDIT." class="heart-fact">
        ...
        <div class="about-fact-box">
                <span class="heart-float">
                       <img src="img/hearty.svg" alt="A little thing I love! - THING HERE PLS EDIT." class="heart-fact">
                </span>                 <p class="about-fact-text"> I opened my own small art business &amp; I hope to do more conventions one day! </p>
        </div>
        <div class="about-fact-box">
                <span class="heart-float">
                       <img src="img/hearty.svg" alt="A little thing I love! - THING HERE PLS EDIT." class="heart-fact">
                </span>                <p class="about-fact-text"> I have no preference for Mac or PC. (I used both OS to make this portfolio!)  </p>
        </div>
        <div class="about-fact-box">
                <span class="heart-float">
                       <img src="img/hearty.svg" alt="A little thing I love! - THING HERE PLS EDIT." class="heart-fact">
                </span>               <p class="about-fact-text"> I love Nintendo games. (Pokemon, Zelda and Animal Crossing are my favourites) </p>
        </div>
